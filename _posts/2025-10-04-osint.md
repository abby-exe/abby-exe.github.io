...
Mr.Nazrul demonstrated solving Session 1 challenge using DNSDumpster — showed how to find:
- IP addresses
- CDN footprints
- Related DNS records and hosts

Moving on, covering the Information Attack Space: overview of tools and how they fit the stack (recon → scanning → detection → remediation).

Examples being discussed now include:
- Nmap for active scanning and port/service discovery
- Microsoft Defender as an example of endpoint detection (commercial)
- Mix of open-source and commercial tools and how to choose them depending on scope/scale
